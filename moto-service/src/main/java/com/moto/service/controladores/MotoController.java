...
import com.moto.service.servicios.MotoServiceImpl;
...
public class MotoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Moto> obtinerMoto(@PathVariable("id") Long id) {
    ...
    public ResponseEntity<List<Moto>> listarMotosPorUsuarioId(
